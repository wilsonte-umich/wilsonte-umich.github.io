...
set REMOTE_SCRIPT=/nfs/turbo/path-wilsonte-turbo/website/wilsonte-umich.github.io/cms.sh
set LOCAL_PORT=3841
set REMOTE_PORT=3841
...
REM After running, access the Shiny app at http://localhost:3841
pause
